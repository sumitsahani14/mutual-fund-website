  ...
  return (
    <>
      ...
      <section className="py-10 sm:py-16">
        <div className="container-wide grid gap-6 sm:gap-8 lg:grid-cols-[260px_1fr]">
          <aside className="-mx-5 sm:mx-0 lg:sticky lg:top-24 lg:self-start">
            <div className="flex gap-2 overflow-x-auto px-5 pb-2 sm:px-0 lg:flex-col lg:overflow-visible lg:pb-0">
              {CALCULATORS.map((c) => (
          ...
          <div>
            <div className="mb-5 sm:mb-6">
              <h2 className="text-xl font-700 text-navy sm:text-2xl" style={{ fontWeight: 700 }}>{current.name}</h2>
              <p className="mt-1 text-sm text-muted-foreground sm:text-base">{current.desc}</p>
            </div>
